  ...
  return (
    <div className="page-attente">
      ...
      <div className="page-attente-content">
        <form className="staging-gate-form" onSubmit={handleSubmit}>
          <p className="staging-gate-label">Accès réservé</p>
          <div className="staging-gate-row">
            <input
              type="password"
              className="staging-gate-input"
              placeholder="Mot de passe"
              value={value}
              autoFocus
              onChange={(e) => { setValue(e.target.value); setError(false); }}
            />
            <button type="submit" className="btn-primary staging-gate-btn">
              Entrer
            </button>
          </div>
          {error && <p className="staging-gate-error">Mot de passe incorrect</p>}
        </form>
